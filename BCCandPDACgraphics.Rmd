...
colnames(hsp.averages.score.graphics) <- c("HSP Score", "Classification")

hsp.averages.score.graphics$Classification[hsp.averages.score.graphics$Classification == "R"] <- "BCC Responders"
hsp.averages.score.graphics$Classification[hsp.averages.score.graphics$Classification == "NR"] <- "BCC Nonresponders"


comparisons <- list(c("BCC Responders", "BCC Nonresponders"), c("BCC Responders", "PDAC"), c("BCC Nonresponders", "PDAC"))

HSP.boxplot <- ggboxplot(hsp.averages.score.graphics, x = "Classification", y = "HSP Score", color = "Classification", palette = c("blue", "red", "purple"), add = "jitter") +
  stat_compare_means(comparisons = comparisons)

HSP.boxplot <- ggpar(p = HSP.boxplot, legend = "none", main = "HSP Genes", font.main = c(24, "bold", "black"), caption = "HSP scores are calculated by taking the arithmetic mean of the average\n gene expression of 15 HSP genes in the macrophage population of each patient.", font.caption = c(9, "italic", "black"), font.x = "bold", font.y = "bold", font.tickslab = 10) +
...
colnames(mhc1.averages.score.graphics) <- c("MHC Class I Score", "Classification")
colnames(mhc2.averages.score.graphics) <- c("MHC Class II Score", "Classification")

mhc1.averages.score.graphics$Classification <- as.character(mhc1.averages.score.graphics$Classification)

mhc1.averages.score.graphics$Classification[mhc1.averages.score.graphics$Classification == "R"] <- "BCC Responders"
mhc1.averages.score.graphics$Classification[mhc1.averages.score.graphics$Classification == "NR"] <- "BCC Nonresponders"

MHC1.boxplot <- ggboxplot(mhc1.averages.score.graphics, x = "Classification", y = "MHC Class I Score", color = "Classification", palette = c("blue", "red", "purple"), add = "jitter") +
  stat_compare_means(comparisons = comparisons)

MHC1.boxplot <- ggpar(p = MHC1.boxplot, legend = "none", main = "MHC Class I Genes", font.main = c(24, "bold", "black"), caption = "MHC Class I scores are calculated by taking the arithmetic mean of the average gene\n expression of HLA-A, HLA-B, HLA-C, HLA-E, and HLA-G in the macrophage population of each patient.", font.caption = c(9, "italic", "black"), font.x = "bold", font.y = "bold", font.tickslab = 10) +
  theme(plot.title = element_text(hjust = 0.5), plot.caption = element_text(hjust = 0.5))
 

mhc2.averages.score.graphics$Classification <- as.character(mhc2.averages.score.graphics$Classification)

mhc2.averages.score.graphics$Classification[mhc2.averages.score.graphics$Classification == "R"] <- "BCC Responders"
mhc2.averages.score.graphics$Classification[mhc2.averages.score.graphics$Classification == "NR"] <- "BCC Nonresponders"

MHC2.boxplot <- ggboxplot(mhc2.averages.score.graphics, x = "Classification", y = "MHC Class II Score", color = "Classification", palette = c("blue", "red", "purple"), add = "jitter") +
  stat_compare_means(comparisons = comparisons)

MHC2.boxplot <- ggpar(p = MHC2.boxplot, legend = "none", main = "MHC Class II Genes", font.main = c(24, "bold", "black"), caption = "MHC Class II scores are calculated by taking the arithmetic mean of the average gene\n expression of 12 MHC Class II genes in the macrophage population of each patient.", font.caption = c(9, "italic", "black"), font.x = "bold", font.y = "bold", font.tickslab = 10) +
  theme(plot.title = element_text(hjust = 0.5), plot.caption = element_text(hjust = 0.5))
 

## Combine all three boxplots

MHC1.boxplot + MHC2.boxplot + HSP.boxplot

## Dimensions: Width = 1800px, height = 575px

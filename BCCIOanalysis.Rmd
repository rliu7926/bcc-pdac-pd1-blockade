...
## Responders are 2, 3, 5 based on mutation count 

BCCIO.su001.treatment.barchart <- ggplot_barcharts(BCCIO.su001@meta.data$treatment, BCCIO.su001@meta.data$seurat_clusters, colors="Set3") + NoLegend()
...
BCCIO.su004.treatment.barchart <- ggplot_barcharts(BCCIO.su004@meta.data$treatment, BCCIO.su004@meta.data$seurat_clusters, colors="Set3") + NoLegend()
BCCIO.su005.treatment.barchart <- ggplot_barcharts(BCCIO.su005@meta.data$treatment, BCCIO.su005@meta.data$seurat_clusters, colors="Paired") + NoLegend()
...
BCCIO.su009.treatment.barchart <- ggplot_barcharts(BCCIO.su009@meta.data$treatment, BCCIO.su009@meta.data$seurat_clusters, colors="Set3") + NoLegend()
...
BCCIO.su012.treatment.barchart <- ggplot_barcharts(BCCIO.su012@meta.data$treatment, BCCIO.su012@meta.data$seurat_clusters, colors="Set3") + NoLegend()
...
BCCIO.responders <- subset(BCCIO, idents=c("su002", "su003", "su005"))
BCCIO.nonresponders <- subset(BCCIO, idents=c("su001", "su004", "su006", "su007", "su008", "su009", "su010", "su012"))
...
BCCIO Patient 1 Analysis

```{r}

Idents(BCCIO.su001) <- BCCIO.su001$seurat_clusters
DimPlot(BCCIO.su001) + NoLegend()

Idents(BCCIO.su001) <- BCCIO.su001$treatment
DimPlot(BCCIO.su001) + NoLegend()

treatment_count <- count(BCCIO.su001@meta.data, c("treatment"))
treatment_count
```
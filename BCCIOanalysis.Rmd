...
for (i in 1:length(BCC.patients.avg.filtered)) {
...
BCC.MHC1.scores.data$Cluster <- rep(levels(Idents(BCCIO)), each=2)
...
BCC.MHC2.scores.data$Cluster <- rep(levels(Idents(BCCIO)), each=2)
...
BCC.HSP.scores.data$Cluster <- rep(levels(Idents(BCCIO)), each=2)

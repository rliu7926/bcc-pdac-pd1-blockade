...
set.seed(001)
bcc.subset <- subset(BCCIO, max.cells.per.ident=100)
...
bcc.pd1.comparison <- ggboxplot(bcc.pd1.averages, x = "Response", y = "PDCD1", palette = c("Red", "Blue"), add = "jitter") + 
  stat_compare_means(method = "anova")
bcc.pdl1.comparison <- ggboxplot(bcc.pd1.averages, x = "Response", y = "CD274", palette = c("Red", "Blue"), add = "jitter") + 
  stat_compare_means(method = "anova")
bcc.pdl2.comparison <- ggboxplot(bcc.pd1.averages, x = "Response", y = "PDCD1LG2", palette = c("Red", "Blue"), add = "jitter") + 
  stat_compare_means(method = "anova")
bcc.tcf7.comparison <- ggboxplot(bcc.pd1.averages, x = "Response", y = "TCF7", palette = c("Red", "Blue"), add = "jitter") + 
  stat_compare_means(method = "anova")

bcc.pd1.comparison + bcc.pdl1.comparison + bcc.pdl2.comparison + bcc.tcf7.comparison

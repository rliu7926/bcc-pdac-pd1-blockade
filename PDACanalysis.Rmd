...
pdac1.read.cell.labels <- read.table("C:\\Users\\rliu0\\Downloads\\Nie Research\\GSE111672_PDAC-A-indrop-filtered-expMat.txt", nrows=1, header=FALSE, sep = "\t", as.is = 1)
...
pdac2.read.cell.labels <- read.table("C:\\Users\\rliu0\\Downloads\\Nie Research\\GSE111672_PDAC-B-indrop-filtered-expMat.txt", nrows=1, header=FALSE, sep = "\t", as.is = 1)

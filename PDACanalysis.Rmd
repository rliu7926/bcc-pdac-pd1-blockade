...
PDAC155698.all.list <- list(PDAC.integrated, PDAC155698.H1, PDAC155698.H2, PDAC155698.H3, PDAC155698.H4)
...
PDAC.all <- IntegrateData(anchorset=PDAC155698.all.anchors, dims=1:50)
...
clusters <- c('TNK', 'TNK', 'DC1', 'UNK', 'MYE1', 'UNK', 'MYE1', 'DC3', 'DC3', 'TNK', 'MYE2', 'DC3', 'MYE2', 'MAST', 'PLASMA', 'B', 'DC2', 'FIB', 'DC2', 'FIB', 'DC3', 'UNK', 'ACINAR', 'PERI', 'DC4', 'TNK', 'ENDO', 'ADC', 'PDC', 'RBC', 'PLAS', 'PLAS')
...
PDAC.all.ductal <- subset(PDAC.all, idents=c("DC1", "DC2", "DC3", "DC4"))

PDAC155698.all.ductal <- PDAC155698.all.ductal ## safety
...
x <- c('M', 'M', 'N', 'N', 'S', 'S', 'M', 'S', 'S', 'S', 'S', 'S', 'S', 'N', 'N', 'S', 'N', 'M', 'N', 'M')
for (i in 1:20) {
...
clusters <- c('CD4+ T cells', 'CD8+ T cells', 'Tregs', 'NK cells', 'NK cells', 'NK cells', 'Proliferating Tregs', 'CD4+ T cells', 'Proliferating Tregs', 'NK cells')
...
Idents(PDAC.all) <- PDAC.all$cluster
PDAC.all.unk <- subset(PDAC.all, idents="UNK")
...
clusters <- c('Granulocytes', 'Granulocytes', 'Granulocytes', 'Dendritic cells', 'Macrophages', 'Endocrine cells', 'Granulocytes')
...
PDAC.all$cluster <- as.character(PDAC.all$cluster)
PDAC.all$cluster[rownames(PDAC.all.unk@meta.data)] <- paste(Idents(PDAC.all.unk))
PDAC.all$cluster <- as.factor(PDAC.all$cluster)
...
PDAC.all <- RenameIdents(object=PDAC.all, 
                         ...
                         'M' = 'Ductal cells: Malignant 1',
                         'MAST' = 'Mast cells',
                         'MYE1' = 'Myeloid cells 1',
                         'MYE2' = 'Myeloid cells 2',
                         ...
                         'PLASMA' = 'Plasma cells',
                         'RBC' = 'Red blood cells',
                         'S'= 'Ductal cells: Malignant 2')
PDAC.all$cluster <- Idents(PDAC.all)
DimPlot(PDAC.all, group.by="cluster", label="TRUE", repel="TRUE")

levels(Idents(PDAC.all)) <- c('Acinar cells', 'Activated dendritic cells', 'B cells', 'Ductal cells: Healthy', 'Ductal cells: Normal', 'Ductal cells: Malignant 1', 'Ductal cells: Malignant 2', 'Endothelial cells', 'Fibroblasts', 'Mast cells', 'Myeloid cells 1', 'Myeloid cells 2', 'pDCs', 'Perivascular cells', 'Plasma cells', 'Red blood cells', )
```

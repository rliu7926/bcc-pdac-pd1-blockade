...
hla.markers.plot <- ggplot(hla.markers.by.patient, aes(x=log_pvaladj, y=avg_logFC, color=GeneNames, size=1.5)) + geom_point()
hla.markers.plot
...
bcc.hla.markers.plot <- ggplot(bcc.hla.markers, aes(x=log_pvaladj, y=avg_logFC, color=GeneNames, size=1.5)) + geom_point()

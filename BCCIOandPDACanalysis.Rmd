...
bcc.pdac.1.volcano <- bioc_volcano(bcc.pdac.1, c("Macrophages"), c("pdac.patient"))




## Doesn't work
for(subset in bcc.pdac.subsets) {
  volcano <- bioc_volcano(subset, c("Macrophages"), c("pdac.patient"), c("BCC"), paste0(subset))
  assign(paste0(subset, ".volcano"), volcano)
  volcano
}
